...
import com.ruoyi.dahua.lib.DynamicParseUtil;
...
public class LibraryLoad {
  ...
  public static String getLoadLibrary(String libraryName) {
    ...
    if(osSelect.isWindows()){
      EXTRACT_PATH = System.getProperty("user.dir") + "\\ruoyi-dahua\\libs\\win64\\";
    }
    if(osSelect.isLinux()){
      EXTRACT_PATH = System.getProperty("user.dir") + "/ruoyi-dahua/libs/linux64/";
    }
