...
import com.ruoyi.isup.service.cmsService.HIKSDKStructure;
import com.sun.jna.*;
...
public interface HCISUPAlarm extends Library {
    ...
    public static class NET_EHOME_ALARM_MSG extends HIKSDKStructure {
    ...
    public static class NET_EHOME_ALARM_ISAPI_INFO extends HIKSDKStructure {
    ...
    public static class NET_EHOME_HEATMAP_REPORT extends HIKSDKStructure {
        public int dwSize;
    ...
    public static class NET_EHOME_HEATMAP_VALUE extends HIKSDKStructure {
        public int dwMaxHeatMapValue;    //最大热度值
        public int dwMinHeatMapValue;    //最小热度值
        public int dwTimeHeatMapValue;   //平均热度值
    }

    public static class NET_EHOME_PIXEL_ARRAY_SIZE extends HIKSDKStructure {
        public int dwLineValue;   //像素点行值
        public int dwColumnValue; //像素点列值
    }

    public static class NET_EHOME_FACESNAP_REPORT extends HIKSDKStructure {
        public int dwSize;
        public byte[] byDeviceID = new byte[MAX_DEVICE_ID_LEN];   //设备注册ID
        public int dwVideoChannel;                  //通道号
    ...
    public static class NET_EHOME_ZONE extends HIKSDKStructure {
        public int dwX;          //X轴坐标
        public int dwY;          //Y轴坐标
    ...
    public static class NET_EHOME_HUMAN_FEATURE extends HIKSDKStructure {
    ...
    public static class NET_EHOME_GPS_INFO extends HIKSDKStructure {
        public int dwSize;
    ...
    public static class NET_EHOME_CID_INFO extends HIKSDKStructure {
        public int dwSize;
        public byte[] byDeviceID = new byte[MAX_DEVICE_ID_LEN];//设备注册ID
    ...
    public static class NET_EHOME_CID_PARAM extends HIKSDKStructure {
    ...
    public static class NET_EHOME_CID_INFO_INTERNAL_EX extends HIKSDKStructure {
    ...
    public static class NET_EHOME_CID_INFO_PICTUREINFO_EX extends HIKSDKStructure {
    ...
    public static class NET_EHOME_ALARM_LISTEN_PARAM extends HIKSDKStructure {
    ...
    public static class NET_EHOME_LOCAL_GENERAL_CFG extends HIKSDKStructure {
        public byte byAlarmPictureSeparate;        //控制透传ISAPI报警数据和图片是否分离，0-不分离，1-分离（分离后走EHOME_ISAPI_ALARM回调返回）
        public byte[] byRes = new byte[127];
    }

    public static class NET_EHOME_ALARM_INFO extends HIKSDKStructure {
        public int dwSize;
    ...
    public static class NET_EHOME_ALARM_STATUS_UNION extends HIKSDKStructure {
    ...
    public static class NET_EHOME_DEV_STATUS_CHANGED extends HIKSDKStructure {
        public byte byDeviceStatus;
        public byte[] byRes = new byte[11];
    }

    public static class NET_EHOME_CHAN_STATUS_CHANGED extends HIKSDKStructure {
    ...
    // 磁盘状态改变
    public static class NET_EHOME_HD_STATUS_CHANGED extends HIKSDKStructure {
    ...
    // 定时上报设备状态项
    public static class NET_EHOME_DEV_TIMING_STATUS extends HIKSDKStructure {
    ...
    // 定时上报通道状态项-单个通道
    public static class NET_EHOME_CHAN_TIMING_STATUS_SINGLE extends HIKSDKStructure {
    ...
    // 定时上报磁盘状态项
    public static class NET_EHOME_HD_TIMING_STATUS_SINGLE extends HIKSDKStructure {
     ...
     * 图片URL 报警
     */
    public static class NET_EHOME_NOTICE_PICURL extends HIKSDKStructure {
        public int dwSize;
     ...
     * 异步失败通知信息结构体
     */
    public static class NET_EHOME_NOTIFY_FAIL_INFO extends HIKSDKStructure {
        public int dwSize;
        public byte[] byDeviceID = new byte[MAX_DEVICE_ID_LEN];
     ...
     * 无线报警信息结构体
     */
    public static class NET_EHOME_ALARMWIRELESSINFO extends HIKSDKStructure {
        public byte[] byDeviceID = new byte[MAX_DEVICE_ID_LEN];
     ...
     * 车载客流统计的定位信息
     */
    public static class NET_EHOME_ALARM_MPDCDATA extends HIKSDKStructure {
     ...
     * 车载客流统计的GPS定位信息
     */
    public static class NET_EHOME_MPGPS extends HIKSDKStructure {
     ...
     * 车载客流统计的GPS定位信息
     */
    public static class NET_EHOME_MPDATA extends HIKSDKStructure {
