  ...
  <div class="app-container">
    <el-tabs v-model="queryParams.hasShare" class="demo-tabs" @tab-click="handleClick">
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5" v-if="queryParams.hasShare !=='true'"  v-hasPermi="['wvp:platform:channelAdd']">
        ...
        <el-col :span="1.5" v-if="queryParams.hasShare ==='true'" v-hasPermi="['wvp:platform:channelRemove']">
          <el-button
              type="danger"
              plain
              icon="Delete"
